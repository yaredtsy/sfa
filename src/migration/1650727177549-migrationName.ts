...
export class migrationName1650727177549 implements MigrationInterface {
    name = 'migrationName1650727177549'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`
            ALTER TABLE "invoice"
            ADD CONSTRAINT "FK_e0bdc38b5b7d8e2424b2f3135ca" FOREIGN KEY ("companyIdId") REFERENCES "company"("id") ON DELETE NO ACTION ON UPDATE NO ACTION
        `);
        await queryRunner.query(`
            ALTER TABLE "invoice"
            ADD CONSTRAINT "FK_dc03299c62025e43c36b755c314" FOREIGN KEY ("truckIdId") REFERENCES "truck"("id") ON DELETE NO ACTION ON UPDATE NO ACTION
        `);
        await queryRunner.query(`
            ALTER TABLE "invoice"
            ADD CONSTRAINT "FK_8c710b7109ea3f06bc4c5e5301d" FOREIGN KEY ("routeIdId") REFERENCES "route"("id") ON DELETE NO ACTION ON UPDATE NO ACTION
        `);
        await queryRunner.query(`
            ALTER TABLE "invoice"
            ADD CONSTRAINT "FK_f0b9978808f583e042282d26302" FOREIGN KEY ("outletIdId") REFERENCES "outlet"("id") ON DELETE NO ACTION ON UPDATE NO ACTION
        `);
        await queryRunner.query(`
            ALTER TABLE "invoice"
            ADD CONSTRAINT "FK_e48e3521ae55f11af35d3833fc2" FOREIGN KEY ("materialIdId") REFERENCES "material"("id") ON DELETE NO ACTION ON UPDATE NO ACTION
        `);
        await queryRunner.query(`
            ALTER TABLE "invoice"
            ADD CONSTRAINT "FK_4bcf3dbe297a9bafbadec5a801e" FOREIGN KEY ("createdById") REFERENCES "user_detail"("id") ON DELETE NO ACTION ON UPDATE NO ACTION
        `);
        await queryRunner.query(`
            ALTER TABLE "outlet"
        ...
        await queryRunner.query(`
            ALTER TABLE "route_market"
            ADD CONSTRAINT "FK_ecbcb7bdc4e4d42c9beac066493" FOREIGN KEY ("createdById") REFERENCES "user_detail"("id") ON DELETE NO ACTION ON UPDATE NO ACTION
        `);
        await queryRunner.query(`
            ALTER TABLE "route"
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        `);
        await queryRunner.query(`
            ALTER TABLE "route_market" DROP CONSTRAINT "FK_ecbcb7bdc4e4d42c9beac066493"
        `);
        await queryRunner.query(`
        ...
        `);
        await queryRunner.query(`
            ALTER TABLE "invoice" DROP CONSTRAINT "FK_4bcf3dbe297a9bafbadec5a801e"
        `);
        await queryRunner.query(`
            ALTER TABLE "invoice" DROP CONSTRAINT "FK_e48e3521ae55f11af35d3833fc2"
        `);
        await queryRunner.query(`
            ALTER TABLE "invoice" DROP CONSTRAINT "FK_f0b9978808f583e042282d26302"
        `);
        await queryRunner.query(`
            ALTER TABLE "invoice" DROP CONSTRAINT "FK_8c710b7109ea3f06bc4c5e5301d"
        `);
        await queryRunner.query(`
            ALTER TABLE "invoice" DROP CONSTRAINT "FK_dc03299c62025e43c36b755c314"
        `);
        await queryRunner.query(`
            ALTER TABLE "invoice" DROP CONSTRAINT "FK_e0bdc38b5b7d8e2424b2f3135ca"
        `);
        await queryRunner.query(`
